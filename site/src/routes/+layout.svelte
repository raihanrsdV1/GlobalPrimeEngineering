			...
			<div>
				...
				<ul class="space-y-3">
					<li class="flex items-start gap-2.5">
						...
						<span class="text-sm text-gray-400">Near Taj Factory, Industrial Area 2, Sharjah - U.A.E.</span>
					</li>
					<li class="flex items-start gap-2.5">
						<svg class="mt-0.5 h-4 w-4 shrink-0 text-gold-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
					...
					<li class="flex items-start gap-2.5">
						...
						<a href="mailto:info@globalprimeengineering.ae" class="text-sm text-gray-400 transition-colors hover:text-white break-all">info@globalprimeengineering.ae</a>
					</li>
					<li class="flex items-start gap-2.5">
						<svg class="mt-0.5 h-4 w-4 shrink-0 text-gold-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
						</svg>
						<a href="tel:+971542576771" class="text-sm text-gray-400 transition-colors hover:text-white">+971 54 257 6771</a>
					</li>
					<li class="flex items-start gap-2.5">
						...
						<a href="https://wa.me/971542576771" class="text-sm text-gray-400 transition-colors hover:text-white">+971 54 257 6771</a>
					</li>
				</ul>
			</div>
		</div>
